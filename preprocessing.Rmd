...
protests2022 <- left_join(acledm[acledm$year == 2022, ], hsm, 
                          by = c("iso3", "year")) # 19579
protests2021 <- left_join(acledm[acledm$year == 2021, ], hsm, 
...
protests2020 <- left_join(acledm[acledm$year == 2020, ], hsm,
                      by = c("iso3", "year")) # 137247
protests1819 <- left_join(acledm[acledm$year %in% 2018:2019, ], hsm,
                      by = c("iso3", "year")) # 149608
protests9717 <- left_join(acledm[acledm$year %in% 1997:2017, ], hsm,
